...
class Laba2:
    def __init__(self):
        ...
        self.main1(), self.main2(), self.printing()
    ...
    def printing(self):
        ...
        print("1.1) Cереднє значення функції відгуку в рядку: Y1сер={0}, Y2сер={1}, Y3сер={2}".format(self.Y1_, self.Y2_, self.Y3_))
        ...
        print("1.7) Перевірка: \n Ruv1 = {0:.3f} < Rкр = 2 \n Ruv2 = {1:.3f} < Rкр = 2 \n Ruv3 = {2:.3f} < Rкр = 2".format(self.Ruv1, self.Ruv2, self.Ruv3))
